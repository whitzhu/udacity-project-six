...
contract("SupplyChain", function (accounts) {
  ...
  // 11th Test
  it("Testing smart contract function refundItem() that allows a retailer to refund coffee purchase", async () => {
    const supplyChain = await SupplyChain.deployed();
    // await supplyChain.addConsumer(consumerID);
    ...
    // Watch the emitted event Purchased()
    supplyChain.Returned(null, (error, event) => {
      eventEmitted = true;
    });

    // Mark an item as Sold by calling function buyItem()
    await supplyChain.refundItem(upc, {
      from: retailerID,
      value: productPrice,
    });
